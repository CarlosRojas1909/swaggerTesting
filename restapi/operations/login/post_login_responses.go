...
/*PostLoginOK Post successful response
...
func (o *PostLoginUnauthorized) WithPayload(payload *models.ReturnCode) *PostLoginUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the post login unauthorized response
func (o *PostLoginUnauthorized) SetPayload(payload *models.ReturnCode) {
	o.Payload = payload
}
...
func (o *PostLoginNotFound) WithPayload(payload *models.ReturnCode) *PostLoginNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the post login not found response
func (o *PostLoginNotFound) SetPayload(payload *models.ReturnCode) {
	o.Payload = payload
}
