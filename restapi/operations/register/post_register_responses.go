...
/*PostRegisterOK Successful Request
...
func (o *PostRegisterNotFound) WithPayload(payload *models.ReturnCode) *PostRegisterNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the post register not found response
func (o *PostRegisterNotFound) SetPayload(payload *models.ReturnCode) {
	o.Payload = payload
}
...
/*PostRegisterDefault Unexpected Error
